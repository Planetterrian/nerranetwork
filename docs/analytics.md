...
| `api/dashboard.json` | rollup of all of the above | `audience` section: `op3`, `youtube`, `site` (GA4), `spotify`, `newsletter` — each with `configured: bool` and compact summaries. | `scripts/generate_dashboard.py` | — |
