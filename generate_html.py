...
NETWORK_SHOWS = {
    "tesla": {
        ...
        "theme_color": "#E31937",
        "meta_description": "Daily Tesla Shorts Time podcast — vehicles, Robotaxi, Optimus, Energy, Solar, Cortex compute, TSLA, and first-principles analysis.",
        "meta_keywords": "Tesla podcast, TSLA news, Tesla stock, Optimus, Megapack, Powerwall, Solar Roof, Cortex, Dojo, FSD, Robotaxi, Tesla Shorts Time",
        "audience": "For Tesla owners, TSLA investors, EV enthusiasts, energy-storage followers, and anyone tracking Tesla's full business.",
        ...
        "resource_categories": [
            ...
            {
                "title": "Energy, Solar & Compute",
                "resources": [
                    {"name": "Tesla Energy", "url": "https://www.tesla.com/energy", "desc": "Megapack, Powerwall, and utility-scale storage — Tesla's energy business"},
                    {"name": "Tesla Solar", "url": "https://www.tesla.com/solarpanels", "desc": "Solar panels and Solar Roof — residential generation paired with Powerwall"},
                    {"name": "Tesla AI Day Presentations", "url": "https://www.youtube.com/results?search_query=tesla+ai+day", "desc": "Technical presentations on FSD, Optimus, Cortex, and Dojo"},
    ...
    "omni_view": {
        ...
        "slug": "omni_view",
        "display_order": 3,
        "description": "The day's most important stories worldwide — calm, balanced, in plain language.",
        ...
        "theme_color": "#0B6FD6",
        "meta_description": "Omni View — the day's most important world news, explained calmly from every side. A daily balanced briefing in plain language, without clickbait or spin.",
        "meta_keywords": "world news, daily briefing, balanced perspectives, media literacy, plain language, unbiased reporting",
        "audience": "For anyone — teenagers to seniors — who wants to actually understand the day's news without clickbait, doom, or spin.",
        "source_highlights": ["BBC", "NPR", "WSJ", "Al Jazeera", "Nikkei Asia", "AllAfrica"],
        "resource_categories": [
            {
        ...
        "resource_categories": [
            ...
            },
            {
                ...
                "resources": [
                    ...
                    {"name": "Cursor", "url": "https://cursor.com", "desc": "The AI code editor (Anysphere) — Grok is selectable in it; a first-class beat of this show's AI & Compute segment"},
                    {"name": "Cursor Changelog", "url": "https://cursor.com/changelog", "desc": "Cursor's latest releases and model integrations, including Grok"},
                    {"name": "Cursor on X", "url": "https://x.com/cursor_ai", "desc": "Official Cursor product updates — agent features, model swaps, and Grok availability"},
