"""Peptides Weekly hooks (Sep 2026, docs/new_shows_plan_2026_09_22.md §4.3).

pre_fetch: narrative memory; this week's curriculum spotlight
(shows/curricula/peptides.yaml, engine/curriculum.py); real Europe PMC
