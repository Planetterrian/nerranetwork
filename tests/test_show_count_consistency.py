...
def test_network_show_count():
    ...
    News and Collingwood Weekly; 25 with Phase 2b: Prediction Markets Daily;
    31 with Phase 3: the five Omni View regional desks and Top World News.)"""
    assert _show_count() == 31
